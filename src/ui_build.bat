pyuic5 -x imagius/ui/mainwindow.ui -o imagius/ui/ui_mainwindow.py
pyuic5 -x imagius/ui/foldermanager.ui -o imagius/ui/ui_foldermanager.py
pyuic5 -x imagius/ui/slideshowwindow.ui -o imagius/ui/ui_slideshowwindow.py
